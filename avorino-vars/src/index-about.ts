...
const HEAD_CODE = [
  '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Rejhinald/avorino@31d0290/avorino-about-head.css">',
  CALENDLY_CSS,
].join('\n');
const FOOTER_CODE = [
  ...
  '<script src="https://cdn.jsdelivr.net/gh/Rejhinald/avorino@31d0290/avorino-about-footer.js"><\/script>',
