...
const HEAD_CODE = [
  '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Rejhinald/avorino@2627e8f/avorino-about-head.css">',
  CALENDLY_CSS,
].join('\n');
const FOOTER_CODE = [
  ...
  '<script src="https://cdn.jsdelivr.net/gh/Rejhinald/avorino@2627e8f/avorino-about-footer.js"><\/script>',
  '<script src="https://cdn.jsdelivr.net/gh/Rejhinald/avorino@2627e8f/avorino-animations.js"><\/script>',
  CALENDLY_JS,
].join('\n');
