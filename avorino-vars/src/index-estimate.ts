...
const HEAD_CODE = [
  ...
  `<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Rejhinald/avorino@${CDN}/avorino-estimate.css">`,
  CALENDLY_CSS,
].join('\n');
const FOOTER_CODE = [
  ...
  `<script src="https://cdn.jsdelivr.net/gh/Rejhinald/avorino@${CDN}/avorino-estimate-footer.js"><\/script>`,
  CALENDLY_JS,
].join('\n');
