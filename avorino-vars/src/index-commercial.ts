...
import {
  ...
  createAllVariables, buildCommercialPage, CommercialPageData,
...
const COMMERCIAL_DATA: CommercialPageData = {
  slug: 'commercial',
  pageName: 'Commercial',
...
document.getElementById('build-page')?.addEventListener('click', async () => {
  ...
  try { await buildCommercialPage(COMMERCIAL_DATA); } catch (err: any) {
