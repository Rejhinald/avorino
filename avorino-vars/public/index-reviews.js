...
// ════════════════════════════════════════════════════════════════
import { webflow, log, logDetail, clearErrorLog, wait, safeCall, getAvorinVars, getOrCreateStyle, clearAndSet, createSharedStyles, setSharedStyleProps, createAllVariables, createPageWithSlug, CALENDLY_CSS, CALENDLY_JS, } from './shared.js';
// ── Page config ──
...
const HEAD_CODE = [
    ...
    '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Rejhinald/avorino@a6d6a3e/avorino-reviews.css">',
    CALENDLY_CSS,
].join('\n');
const FOOTER_CODE = [
    '<script src="https://cdn.jsdelivr.net/gh/Rejhinald/avorino@a6d6a3e/avorino-reviews.js"><\/script>',
    CALENDLY_JS,
].join('\n');
// ── Update panel UI ──
