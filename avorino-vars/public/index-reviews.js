...
const HEAD_CODE = [
    ...
    '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Rejhinald/avorino@9d6ec3d/avorino-reviews.css">',
    CALENDLY_CSS,
].join('\n');
const FOOTER_CODE = [
    '<script src="https://cdn.jsdelivr.net/gh/Rejhinald/avorino@9d6ec3d/avorino-reviews.js"><\/script>',
    CALENDLY_JS,
].join('\n');
// ── Update panel UI ──
