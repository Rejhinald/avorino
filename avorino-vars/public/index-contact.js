...
// ════════════════════════════════════════════════════════════════
import { webflow, log, logDetail, clearErrorLog, wait, safeCall, getAvorinVars, getOrCreateStyle, freshStyle, clearAndSet, createSharedStyles, setSharedStyleProps, createAllVariables, createPageWithSlug, buildCTASection, applyCTAStyleProps, buildCleanForm, } from './shared.js';
// ── Page config ──
...
async function buildContactPage() {
    ...
    await buildCTASection(body, v, 'Ready to start building?', 'Call (714) 900-3676', 'tel:7149003676', 'Fill Out the Form', '#ct-hero');
    // ═══════════════ APPLY STYLES ═══════════════
