(function() {
  ...
  /* ═══════════════════════════════════════════════
     MAGAZINE EMBED — FlipHTML5 with click-to-interact
     ═══════════════════════════════════════════════ */
  function initMagazine() {
    var cfg = window.__avMagazines && window.__avMagazines[0];
    ...
    section.innerHTML =
      '<div class="av-magazine-inner">' +
        '<div class="av-magazine-header">' +
          ...
          '<h2 class="av-magazine-heading">' + (cfg.heading || 'Explore Our Magazine') + '</h2>' +
          (cfg.desc ? '<p class="av-magazine-desc">' + cfg.desc + '</p>' : '') +
        '</div>' +
        '<div class="av-magazine-frame">' +
          '<div class="av-magazine-overlay" data-el="magazine-overlay">' +
            '<div class="av-magazine-overlay-content">' +
              '<div class="av-magazine-overlay-icon">' +
                ...
                '</svg>' +
              '</div>' +
              '<span class="av-magazine-overlay-title">' + (cfg.title || 'Magazine') + '</span>' +
          ...
          '<iframe class="av-magazine-iframe" src="" data-src="' + cfg.url + '" title="' + (cfg.title || 'Magazine') + '" allowfullscreen style="pointer-events:none;"></iframe>' +
        '</div>' +
      '</div>';

    /* Insert before CTA section */
    var cta = document.querySelector('[class*="av-cta"]');
    if (cta && cta.parentNode) {
      ...
      if (last && last.parentNode) {
        last.parentNode.insertBefore(section, last);
      } else {
    ...
    /* Inject styles */
    if (!document.getElementById('av-magazine-styles')) {
      var s = document.createElement('style');
      s.id = 'av-magazine-styles';
      s.textContent =
        '.av-magazine{padding:128px 80px;background-color:#111111;color:#f0ede8;position:relative;overflow:hidden}' +
        '.av-magazine-inner{max-width:1280px;margin:0 auto}' +
        '.av-magazine-header{margin-bottom:64px}' +
        '.av-magazine-label{font-family:"DM Sans",system-ui,sans-serif;font-size:13px;font-weight:400;letter-spacing:0.3em;text-transform:uppercase;color:#f0ede8;opacity:0.35;margin-bottom:28px}' +
        '.av-magazine-heading{font-family:"DM Serif Display",Georgia,serif;font-size:clamp(32px,3.5vw,56px);font-weight:400;line-height:1.12;letter-spacing:-0.02em;color:#f0ede8;margin-bottom:16px}' +
        '.av-magazine-desc{font-family:"DM Sans",system-ui,sans-serif;font-size:18px;line-height:1.7;color:#f0ede8;opacity:0.5;max-width:560px}' +
        '.av-magazine-frame{position:relative;width:100%;height:85vh;min-height:600px;border-radius:16px;overflow:hidden;border:1px solid rgba(201,169,110,0.1);background-color:#0a0a0a;box-shadow:0 32px 80px rgba(0,0,0,0.5),inset 0 1px 0 rgba(201,169,110,0.06);transition:border-color 0.4s ease,box-shadow 0.4s ease}' +
        '.av-magazine-frame--active{border-color:rgba(201,169,110,0.25);box-shadow:0 32px 80px rgba(0,0,0,0.6),0 0 0 1px rgba(201,169,110,0.08),inset 0 1px 0 rgba(201,169,110,0.1)}' +
        '.av-magazine-overlay{position:absolute;inset:0;z-index:3;display:flex;align-items:center;justify-content:center;background:radial-gradient(ellipse at center,rgba(10,10,10,0.7) 0%,rgba(10,10,10,0.92) 100%);cursor:pointer;transition:opacity 0.4s ease}' +
        '.av-magazine-overlay:hover .av-magazine-overlay-cta{color:rgba(201,169,110,1)}' +
        '.av-magazine-overlay:hover .av-magazine-overlay-icon svg{transform:scale(1.08)}' +
        '.av-magazine-overlay-content{display:flex;flex-direction:column;align-items:center;gap:16px;text-align:center}' +
        '.av-magazine-overlay-icon{margin-bottom:8px}' +
        '.av-magazine-overlay-icon svg{transition:transform 0.3s ease}' +
        '.av-magazine-overlay-title{font-family:"DM Serif Display",Georgia,serif;font-size:28px;color:#f0ede8;opacity:0.9}' +
        '.av-magazine-overlay-cta{font-family:"DM Sans",system-ui,sans-serif;font-size:14px;font-weight:500;letter-spacing:0.1em;text-transform:uppercase;color:rgba(201,169,110,0.75);display:inline-flex;align-items:center;gap:6px;transition:color 0.3s ease}' +
        '.av-magazine-overlay-hint{font-family:"DM Sans",system-ui,sans-serif;font-size:12px;color:#f0ede8;opacity:0.25;margin-top:4px}' +
        '.av-magazine-close{position:absolute;top:16px;right:20px;z-index:4;font-family:"DM Sans",system-ui,sans-serif;font-size:13px;font-weight:500;letter-spacing:0.06em;color:rgba(201,169,110,0.7);background:rgba(17,17,17,0.85);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);padding:8px 16px;border-radius:100px;border:1px solid rgba(201,169,110,0.12);cursor:pointer;display:flex;align-items:center;gap:6px;transition:color 0.3s ease,border-color 0.3s ease}' +
        '.av-magazine-close:hover{color:rgba(201,169,110,1);border-color:rgba(201,169,110,0.3)}' +
        '.av-magazine-iframe{width:100%;height:100%;border:none;display:block}' +
        '@media(max-width:767px){.av-magazine{padding:80px 24px}.av-magazine-frame{height:75vh;min-height:500px;border-radius:12px}.av-magazine-overlay-title{font-size:22px}}' +
        '@media(max-width:478px){.av-magazine{padding:64px 16px}.av-magazine-frame{height:70vh;min-height:450px}}';
