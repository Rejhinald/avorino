(function() {
  ...
  function initMagazine() {
    ...
    var frame = holder.parentElement; /* av-mag-frame div */

    /* Build overlay + iframe inside the holder */
    holder.innerHTML =
