(function() {
  ...
  // MOBILE OVERRIDE — inject a <style> tag that beats Webflow's specificity
  function injectMobileStyles() {
    if (window.innerWidth > 767) return;
    if (document.getElementById('av-mobile-fix')) return;
    ...
    s.textContent = [
      ...
      '  .hero-overlay { position: absolute !important; inset: 0 !important; width: 100% !important; height: 100% !important; background: transparent !important; background-color: transparent !important; opacity: 1 !important; z-index: 0 !important; }',
      '  .hero-overlay::after { content: "" !important; position: absolute !important; inset: 0 !important; width: 100% !important; height: 100% !important; background: rgba(0,0,0,0.2) !important; z-index: 5 !important; pointer-events: none !important; }',
      '  .div-block-2 { display: none !important; }',
      '  .hero-overlay .w-background-video { position: absolute !important; inset: 0 !important; width: 100% !important; height: 100% !important; z-index: 1 !important; }',
      '  .hero-overlay .w-background-video video { position: absolute !important; inset: 0 !important; width: 100% !important; height: 100% !important; object-fit: cover !important; }',
      '  .hero-content { position: absolute !important; bottom: 24px !important; left: 16px !important; right: 16px !important; z-index: 10 !important; }',
      '  .hero-scroll-indicator { z-index: 10 !important; position: absolute !important; bottom: 20px !important; right: 16px !important; left: auto !important; transform: none !important; }',
      // Stats
      '  .stats { padding: 48px 16px !important; }',
      '  .stats-grid { grid-template-columns: 1fr 1fr !important; gap: 28px 20px !important; }',
      '  .stat-item { display: flex !important; flex-direction: column !important; align-items: center !important; text-align: center !important; }',
      '  .stat-digits { justify-content: center !important; }',
      '  .flip-card { width: 36px !important; height: 50px !important; }',
      '  .flip-card-top, .flip-card-bottom, .flip-card-flip-top, .flip-card-flip-bottom { font-size: 26px !important; }',
      '  .stat-suffix, .stat-separator { font-size: 22px !important; }',
      '  .stat-label { font-size: 10px !important; letter-spacing: .15em !important; margin-top: 10px !important; text-align: center !important; }',
      // Featured section
      '  .featured { padding: 48px 16px !important; overflow: hidden !important; }',
      '  .featured-label { margin-bottom: 24px !important; }',
      '  .featured-image-wrap { width: 100% !important; height: 60vw !important; min-height: 220px !important; max-height: 300px !important; overflow: hidden !important; border-radius: 8px !important; clip-path: none !important; }',
      ...
      '  .featured-panel { margin: 0 !important; padding: 24px 16px !important; max-width: 100% !important; width: 100% !important; box-sizing: border-box !important; overflow: hidden !important; background: #111 !important; opacity: 1 !important; transform: none !important; translate: none !important; color: #f0ede8 !important; border-radius: 8px !important; }',
      '  .featured-panel * { color: #f0ede8 !important; }',
      '  .featured-panel-title { font-size: clamp(24px, 6vw, 32px) !important; word-break: break-word !important; color: #f0ede8 !important; width: 100% !important; }',
      '  .featured-panel-title span { color: #f0ede8 !important; }',
      '  .featured-panel-meta { flex-direction: column !important; gap: 4px !important; width: 100% !important; color: rgba(240,237,232,0.7) !important; font-size: 15px !important; }',
      '  .featured-panel-meta span { display: block !important; color: rgba(240,237,232,0.7) !important; }',
      '  .featured-meta-label { font-size: 11px !important; letter-spacing: .1em !important; text-transform: uppercase !important; color: rgba(240,237,232,0.45) !important; margin-top: 12px !important; }',
      '  .featured-meta-value { color: #f0ede8 !important; }',
      ...
      '  .featured-grid-card-title { font-size: clamp(18px, 5vw, 22px) !important; }',
      // Process
      '  .process { padding: 64px 16px !important; }',
      '  .process-heading { font-size: clamp(28px, 7vw, 36px) !important; }',
      '  .process-header p { font-size: 17px !important; }',
      '  .process-slide-title { font-size: clamp(22px, 5.5vw, 28px) !important; }',
      '  .process-slide-body { font-size: 16px !important; line-height: 1.6 !important; }',
      '  .process-vis { display: none !important; }',
      '  .process-num { display: none !important; }',
      '  .process-stage { grid-template-columns: 1fr !important; min-height: auto !important; }',
      '  .process-slides { min-height: auto !important; }',
      // Press logos
      '  .press-item { flex: 0 0 80px !important; height: 80px !important; }',
      '  .press-item img { width: 80px !important; height: 80px !important; }',
      '}'
    ].join('\n');
    document.head.appendChild(s);
  }
  injectMobileStyles();
  window.addEventListener('resize', injectMobileStyles);
  ...
  function initFeaturedReveal() {
    ...
    if (isMobile) {
      // Mobile: CSS handles everything via injected <style>, skip all GSAP
      return;
    }
